export const defaultContent = {
  ...
  experiences: [
    { id: 1, title: 'Undergraduate Researcher', company: 'Hacettepe University — BAP', period: 'May 2026 – Present', details: 'Hardware-aware edge AI optimization for real-time UAV-based search-and-rescue. Benchmarked 14 detector variants (YOLO v5–v11, RT-DETR, RF-DETR) across 278 configurations on the WiSARD thermal dataset. TensorRT FP16 is the highest-impact optimization. Published at ICHORA 2026.', type: 'work' },
    { id: 2, title: 'Generative AI Research Intern', company: 'UNDP IICPSD — SDG AI Lab', period: 'Nov 2024 – May 2026', details: 'Production LLM pipelines for document analysis, QA, and stakeholder intelligence. Sole developer of the AI Stakeholder Mapping Tool — Django, Next.js, PostgreSQL/pgvector, Celery, Redis — with NER, semantic search, RAG-based summarization, and NL query interface for policy document analysis at scale.', type: 'work' },
    { id: 3, title: 'Computer Vision Engineer', company: 'Oasis Global Energy Technology Software', period: 'Jul 2025 – Sep 2025', details: 'End-to-end CV workflows for solar panel defect detection using multi-modal drone imagery (IR, EL, RGB). Trained CNN models for field deployment. Automated defect detection and reporting pipelines.', type: 'work' },
    { id: 4, title: 'Frontend Development Engineer', company: 'BUTHUR QSTP, Doha (Remote)', period: 'May 2025 – Jul 2025', details: 'Frontend components for a multi-region education platform. Integrated REST APIs and role-based authentication workflows.', type: 'work' },
    { id: 5, title: 'Computer Vision Engineer', company: 'Optima Engineering, Ankara', period: 'Aug 2024 – Oct 2024', details: 'Real-time driver and steering wheel detection (YOLO, Faster R-CNN) for edge inference. Labeled and augmented datasets for varied conditions.', type: 'work' },
    { id: 6, title: 'Data Science Researcher', company: 'ORSAM — Center for Middle Eastern Studies', period: 'Aug 2023 – Oct 2023', details: 'Sentiment and discourse analysis on Arabic social media datasets. NLP pipelines and interaction networks to identify influencers and propagation patterns.', type: 'work' },
  ],
}
